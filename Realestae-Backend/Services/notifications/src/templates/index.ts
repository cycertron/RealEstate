...
<head>
    ...
    <title>Welcome to Realestae</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="footer-section">
            ...
            <div class="social-icons">
                <a href="https://facebook.com/realestae" title="Facebook">f</a>
                <a href="https://instagram.com/realestae" title="Instagram">📷</a>
                <a href="https://twitter.com/realestae" title="Twitter">𝕏</a>
                <a href="https://tiktok.com/@realestae" title="TikTok">♪</a>
                <a href="https://youtube.com/realestae" title="YouTube">▶</a>
            </div>
            <div class="address">
                [YOUR ADDRESS HERE]<br>
                Phone: [YOUR PHONE]<br>
                Email: support@realestae.com
            </div>
            <div class="copyright">
                © 2025 Realestae. All rights reserved.
            </div>
        </div>
    </div>
</body>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #888;">Need help? Contact our support team at support@realestae.com</p>
        </div>
        <div class="divider"></div>
        <div class="footer-section">
            <div class="footer-links">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hi {{user_name}},</p>
            <p>We received a request to reset your Realestae account password. Click the button below to create a new password.</p>
            <div class="link-box">
            ...
            • Always use the official Realestae app or website
            </p>
        </div>
        <div class="divider"></div>
        <div class="footer-section">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning-box">
                ...
                • Realestae staff will never ask for this code<br>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hi {{user_name}},</p>
            <p>Your Realestae account has been successfully deleted. All your personal data has been removed from our servers.</p>
            ...
            <p style="font-size: 13px; color: #b0b0b0; margin-top: 20px;">Thank you for being part of the Realestae community. We hope to see you again in the future!<br><br>
            Questions or concerns? Contact us at support@realestae.com
            </p>
        </div>
        <div class="divider"></div>
        <div class="footer-section">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 13px; color: #b0b0b0; margin-top: 20px;">
                ...
                Contact our support team at support@realestae.com or call {{support_phone}}. We're here to help!
            </p>
        </div>
        <div class="divider"></div>
        <div class="footer-section">
