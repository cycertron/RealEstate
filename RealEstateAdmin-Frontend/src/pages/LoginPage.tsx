    ...
    try {
      ...
      if (response.data?.data) {
        ...
        if (userData.role?.toLowerCase() === 'admin') {
          ...
          setError('Access denied: Agency Admin access required');
        }
      }
    } catch (err: any) {
    ...
    <>
      ...
      <div className="login-root">
          ...
          <div className="card">
            <div className="card-inner">
              ...
              <div className="logo-wrap">
                <img src="/Logo.png" alt="Estatly" className="logo-img" />
                <span className="logo-text">Estatly</span>
              </div>

              <h1 className="heading">Agency <em>Portal</em></h1>
              <p className="subheading">Real Estate CRM &amp; Management</p>
        ...
        <div className="login-right">
          <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200" alt="" aria-hidden="true" />
          <div className="right-caption">
            <p>"Premium properties,<br />smarter deals."</p>
            <span>Estatly · Agency Suite</span>
          </div>
        </div>
      </div>
    </>
