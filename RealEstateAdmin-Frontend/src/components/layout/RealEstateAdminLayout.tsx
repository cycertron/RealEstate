...
const RealEstateAdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'bookings',  path: '/bookings',  label: 'Deals',       icon: '◈',  section: 'Main' },
    { id: 'guests',    path: '/guests',    label: 'Clients',     icon: '●',  section: 'Main' },
    { id: 'messages',  path: '/messages',  label: 'Messages',    icon: '◆',  section: 'Properties', badge: '4' },
    { id: 'rooms',     path: '/rooms',     label: 'Listings',    icon: '🏠', section: 'Properties' },
    { id: 'reviews',   path: '/reviews',   label: 'Reviews',     icon: '★',  section: 'Properties' },
    { id: 'earnings',  path: '/earnings',  label: 'Commission',  icon: '💰', section: 'Business' },
  ...
  const sections = ['Main', 'Properties', 'Business'];
        ...
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          <div className="text-center">
            <div className={`text-2xl font-bold font-playfair ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
              {sidebarOpen ? 'Estatly' : 'E'}
            </div>
            {sidebarOpen && (
              <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">Real Estate CRM</div>
            )}
          </div>
        </div>
...
export default RealEstateAdminLayout;
