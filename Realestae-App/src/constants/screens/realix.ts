...
export const realixFaqs = [
  {
    id: 'how-realix-works',
    question: 'How does Realestae work?',
    answer:
...
export const realixNotificationFeed = [
  ...
  },
  {
    ...
    message:
      'Welcome to Realestae! Your account is ready to explore hotels across Nepal. Start discovering amazing stays in Kathmandu, Pokhara, and beyond!',
