...
```bash
git clone https://github.com/cycertron/Realestae.git
cd Realestae
```
...
| Email | Password |
|-------|----------|
| admin@realestae.com | admin123 |
| manager@realestae.com | manager123 |
...
```bash
cd ../Realestae-Backend

# Create environment files for each service
# (See Realestae-Backend/README.md for details)
...
```bash
cd Realestae-Backend/Services/Auth
