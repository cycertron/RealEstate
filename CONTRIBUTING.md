# Contributing to Realestae

Thank you for your interest in contributing to Realestae! We appreciate all contributions, whether they are bug reports, feature requests, or code changes.

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Realestae.git`
3. Create a branch: `git checkout -b feature/your-feature-name`
4. Install dependencies:
   ```bash
   cd Admin-Frontend
   npm install
   cd ../Realestae-Backend/Packages
   npm install
   ```
